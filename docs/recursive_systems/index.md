...
def split_space(curve, dir, param):
    ...
    PI = math.pi
#    print(vecs[dir])
    vec_1 = (vecs[dir]*math.sin(theta)-vecs[dir]*math.cos(theta)) * dims[dir] * param
    ...
    vec_2 = (vecs[other_dir]*math.sin(theta)- vecs[other_dir]*math.cos(theta))* dims[other_dir]
...
def split_space(curve, rp):
    ...
    # find the center to rotate(center for bounding box)        
    ...
    #   rotation begins 
    t = rh.Transform.Rotation(rp * math.pi * 2, rh.Vector3d(0,0,1),center_point)
